...
int main(int argc, char* argv[]) {
    ...
    // Initialisation IA + plateau
    initialiser_zobrist();
    initialiser_transpo_lock();
    initialiser_killer_moves();

    Partie partie;
    partie.plateau = creer_plateau();            // plus de nb_cases dans Partie
    ...
    printf("📡 Abonné au topic adverse : %s\n", topic_recv);
