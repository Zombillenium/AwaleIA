...
public class Arbitre {
    ...
    public static void main(String[] args) throws Exception {
        // Lancement de main_eval comme joueur A et B pour une partie automatique
        Process A = new ProcessBuilder("c:\\Users\\gouri\\OneDrive - Université Côte d'Azur\\Bureau\\Cours\\M1_IA\\IA_game_programing\\AwaleIA\\rendu\\main_eval.exe").start();
        Process B = new ProcessBuilder("c:\\Users\\gouri\\OneDrive - Université Côte d'Azur\\Bureau\\Cours\\M1_IA\\IA_game_programing\\AwaleIA\\rendu\\main_eval.exe").start();
